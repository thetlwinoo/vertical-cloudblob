...
To build the final jar and optimize the cloudblob application for production, run:
...
[setting up continuous integration]: https://www.jhipster.tech/documentation-archive/v6.9.0/setting-up-ci/ '# vertical-cloudblob'
